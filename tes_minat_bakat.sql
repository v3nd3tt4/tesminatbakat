...
CREATE DATABASE `db_minat_bakat` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_minat_bakat`;
...
CREATE TABLE `tb_temporary_soal` (
  ...
  `status` varchar(255) DEFAULT NULL,
  `id_riwayat_tes` int(11) DEFAULT NULL,
...
CREATE TABLE `view_skor` (`id_kategori_soal` int(11), `id_siswa` int(11), `skor` decimal(32,0));
