...
class Kategori_sekolah extends CI_Controller {
	...
	{
		$get_data = $this->db->get('tb_kategori_sma');
		$data = array(
			'page' => 'kategori_sekolah/index',
			'link' => 'kategori_sekolah',
			'script' => 'kategori_sekolah/script',
			'data' => $get_data
		);
	...
	public function store(){
		...
		$simpan = $this->db->insert('tb_kategori_sma', $data);
		if($simpan){
			$return = array(
				'status' => 'success',
	...
	public function update(){
		...
		$simpan = $this->db->update('tb_kategori_sma', $data, array('id_kategori_sma' => $this->input->post('id_kategori_sma', true)));
		if($simpan){
			$return = array(
				'status' => 'success',
	...
	public function remove(){
		$param = array(
			'id_kategori_sma' => $this->input->post('id', true),
		);

		$delete = $this->db->delete('tb_kategori_sma', $param);
		if($delete){
			$return = array(
				'status' => 'success',
	...
	public function get_data(){
		...
		$get_data = $this->db->get_where('tb_kategori_sma', $param);
