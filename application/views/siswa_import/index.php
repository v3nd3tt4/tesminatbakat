	  ...
	  <div class="section-body">
	  	<div class="card">
	        <div class="card-wrap">
	          ...
	          <div class="card-body">
	            <p>silahkan download template <a href="<?=base_url()?>assets/template_siswa.csv" class="btn btn-primary btn-sm"><i class="fas fa-download"></i> di sini</a>, untuk mengimport siswa</p>
