	...
	$(document).ready( function () {
	    ...
	    $(document).on('click', '.btn-hapus', function(e){
	    	...
	    	$(document).on('click', '.btn-ya-hapus', function(e){
	    		...
	    		$('.notif').html('Loading...');
	    		$.ajax({
		    		url: '<?=base_url()?>pertanyaan/remove',
		    		data: 'id='+id,
		    		type: 'POST',
		    		dataType: 'JSON',
		    		success: function(msg){
	    ...
	    $(document).on('click', '.btn-edit', function(e){
	    	...
	    	$('#modal-edit').modal();
	    	$.ajax({
	    		url: '<?=base_url()?>pertanyaan/get_data',
	    		data: 'id='+id,
	    		type: 'POST',
	    		dataType: 'JSON',
	    		success: function(msg){
	    			$('#id_kategori_pertanyaan_edit').val(msg.id_kategori_soal);
	    			$('#nama_kategori_pertanyaan_edit').val(msg.nama_kategori);
	    			$('#keterangan_edit').val(msg.keterangan);
	    		}
	    	});
	    });
	} );
